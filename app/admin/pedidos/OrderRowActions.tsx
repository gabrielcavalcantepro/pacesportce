...
export default function OrderRowActions({ order, onStatusChange }: Props) {
  ...
  // A tabela de pedidos tem overflow-x-auto, o que também corta o menu
  // verticalmente para as últimas linhas (efeito colateral do CSS: um eixo com
  // overflow diferente de visible força o outro a cortar também). Renderizar o
  // menu num portal, posicionado pelas coordenadas reais do botão, evita o corte.
      ...
      {menuOpen &&
        ...
        createPortal(
          <div
            ...
            className="w-60 bg-[#1e1e1e] border border-[#2a2a2a] rounded-lg shadow-lg z-50 py-1"
          >
            <Link
